          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: _ChatMessageContent(message: widget.message, isUser: isUser),
                  ),
                  if (!isUser && !widget.message.isThinking)
                    GestureDetector(
              ...
              if (!widget.message.isThinking && widget.message.citations != null && widget.message.citations!.isNotEmpty) ...[
